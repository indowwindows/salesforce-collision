    ...
    var inject = function(mutationsList) {
        ...
        for (var mutation of mutationsList) {
            ...
            if (document.getElementById("errorDiv_ep").textContent.indexOf("The record you were editing was modified by") >= 0) {
                ...
                //we are injecting the script onto the page so that it can have access to and interact with salesforce javascript objects (although we are not currently using them in this version)
